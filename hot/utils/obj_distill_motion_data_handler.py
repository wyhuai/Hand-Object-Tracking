...
class MultiMotionDataHandler:
    def __init__(self, motion_file, device, key_body_ids, cfg, num_envs, max_episode_length, reward_weights_default, 
                ...
                postproc_hopdata=False, duplicate_last_frame=False, map_env_2_object=None):
        self.device = device
        ...
        self.postproc_hopdata = postproc_hopdata #V1
    ...
    def load_motion(self, motion_file):
        ...
        for i, seq_path in enumerate(all_seqs):
            ...
            self._map_motion_2_object[i] = loaded_dict['obj_id']
            ##############################################
    ...
    def _process_sequence(self, seq_path):
        ...
        if isinstance(hoi_data, torch.Tensor):
            loaded_dict['hoi_data'] = torch.cat((
                ...
                loaded_dict['root_rot'].to(self.device), #changeged by me as I want quat
                ...
                loaded_dict['key_body_pos'].to(self.device), #haha for my own purpose
    ...
    def get_initial_state(self, env_ids, motion_ids, start_frames):
        ...
        for i, env_id in enumerate(env_ids):
            ...
            if self.play_dataset or self.postproc_hopdata:
                start_frame = 0 
            else:
